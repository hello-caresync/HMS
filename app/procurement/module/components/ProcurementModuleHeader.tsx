...
type ProcurementModuleHeaderProps = {
  lookupValue: string;
  onLookupChange: (value: string) => void;
  resultCount?: number;
};

export default function ProcurementModuleHeader({ lookupValue, onLookupChange, resultCount }: ProcurementModuleHeaderProps) {
  return (
    <header className="shrink-0 border-b border-[#E2E8F0] bg-white px-4 py-2">
      <div className="mb-1.5 flex flex-wrap items-center justify-between gap-2">
        <div>
          <h1 className="text-base font-bold text-[#0F172A]">Procurement Management (P2P)</h1>
          <p className="text-[9px] text-slate-500">Requisitions · approvals · RFQ · tenders · three-way match · vendor payments · AI sourcing</p>
        </div>
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search procurement — PR #, department, budget line, or item"
